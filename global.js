...
// overworld blocks
const BLOCK_GRASS       = new BlockInfo("b_grass",          "assets/blocks/over/grass.png");
const BLOCK_DIRT        = new BlockInfo("b_dirt",           "assets/blocks/over/dirt.png");
const BLOCK_STONE       = new BlockInfo("b_stone",          "assets/blocks/over/stone.png", 2, ITEM_COBBLESTONE);
const BLOCK_OAK_LOG     = new BlockInfo("b_oak_log",        "assets/blocks/over/oak_log.png", 2);
const BLOCK_IRON_ORE    = new BlockInfo("b_iron_ore",       "assets/blocks/over/iron_ore.png", 3);
const BLOCK_DIAMOND_ORE = new BlockInfo("b_diamond_ore",    "assets/blocks/over/diamond_ore.png", 5);
